...
internal class Asset: NSObject {
  ...
  @objc(AssetImages) internal class Images: NSObject {
    ...
    internal static let bubbles1 = ImageAsset(name: "bubbles1")
    internal static let bubbles2 = ImageAsset(name: "bubbles2")
    internal static let bubbles3 = ImageAsset(name: "bubbles3")
    internal static let bubbles4 = ImageAsset(name: "bubbles4")
    ...
    internal static let onboardingBackgroundDark = ImageAsset(name: "onboarding_background_dark")
    internal static let onboardingBackgroundLight = ImageAsset(name: "onboarding_background_light")
    internal static let onboardingCelebrationIcon = ImageAsset(name: "onboarding_celebration_icon")
    internal static let onboardingCenterCircle = ImageAsset(name: "onboarding_center_circle")
    internal static let onboardingCenterCircleDark = ImageAsset(name: "onboarding_center_circle_dark")
    internal static let onboardingCenterCircleLight = ImageAsset(name: "onboarding_center_circle_light")
    ...
    internal static let voiceMessageTranscriptionButton = ImageAsset(name: "voice_message_transcription_button")
    ...
    internal static let btnUploadPicture = ColorAsset(name: "BtnUploadPicture")
    ...
    internal static let vipCalls = ImageAsset(name: "vip_calls")
    internal static let vipDesign = ImageAsset(name: "vip_design")
    internal static let vipEmoji = ImageAsset(name: "vip_emoji")
    internal static let vipNoAds = ImageAsset(name: "vip_no_ads")
    internal static let vipVoice = ImageAsset(name: "vip_voice")
    ...
    internal static let wallpaper1 = ImageAsset(name: "wallpaper1")
    internal static let wallpaper2 = ImageAsset(name: "wallpaper2")
    internal static let wallpaper3 = ImageAsset(name: "wallpaper3")
    internal static let wallpaper4 = ImageAsset(name: "wallpaper4")
    internal static let wallpaper5 = ImageAsset(name: "wallpaper5")
    internal static let wallpaper6 = ImageAsset(name: "wallpaper6")
    internal static let wallpaper7 = ImageAsset(name: "wallpaper7")
    internal static let bg2 = ImageAsset(name: "bg2")
    internal static let bg3 = ImageAsset(name: "bg3")
    internal static let bg3Dark = ImageAsset(name: "bg_3_dark")
    internal static let bg3Light = ImageAsset(name: "bg_3_light")
    internal static let launchScreenLogo = ImageAsset(name: "launch_screen_logo")
    internal static let logoMini = ImageAsset(name: "logo_mini")
  }
  @objcMembers
